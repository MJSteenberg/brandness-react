export default function FloatingChat() {
  return (
    <div className="pointer-events-none fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3 sm:bottom-8 sm:right-8">
      <button
        type="button"
        className="pointer-events-auto relative flex h-16 w-16 items-center justify-center rounded-full bg-accent text-white shadow-[0_10px_24px_rgba(244,78,34,0.22)] transition hover:-translate-y-1 hover:bg-accentDark"
      >
